...
![默认样式](../../../images/默认样式.png)

#### 卡片样式

![卡片样式](../../../images/卡片样式.png)
...
在使用过程中可以根据布局空间，灵活使用不同尺寸的多选按钮。

![尺寸](../../../images/尺寸-1613834.png)

#### 多选卡片

依据内容大小自动撑满，与容器内间距保持16**px**即可。

![卡片尺寸](../../../images/卡片尺寸-1613738.png)
